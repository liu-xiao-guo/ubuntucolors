...
UBUNTU_TRANSLATION_DOMAIN="ubuntucolors.liu-xiao-guo"
...
aptest.commands = bash $$PWD/ubuntucolors/tests/autopilot/run
aptest.depends  = sub-ubuntucolors

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/ubuntucolors/tests/unit
unittest.depends  = sub-ubuntucolors
